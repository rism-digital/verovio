    ...
    int deepness, bool direction)
{
    ...
    if (functor->m_visibleOnly) {
        if (this->IsEditorialElement()) {
            EditorialElement *editorialElement = static_cast<EditorialElement *>(this);
            ...
            Mdiv *mdiv = static_cast<Mdiv *>(this);
            assert(mdiv);
            ...
            SystemElement *systemElement = static_cast<SystemElement *>(this);
            ...
            if (filters && !filters->empty()) {
                ...
                ArrayOfComparisons::iterator comparisonIter
                    = std::find_if(filters->begin(), filters->end(), [classId](Comparison *iter) -> bool {
                          ClassIdComparison *attComparison = static_cast<ClassIdComparison *>(iter);
...
{
    AddLayerElementToFlatListParams *params = static_cast<AddLayerElementToFlatListParams *>(functorParams);
    assert(params);
...
{
    FindByUuidParams *params = static_cast<FindByUuidParams *>(functorParams);
    assert(params);
...
{
    FindByComparisonParams *params = static_cast<FindByComparisonParams *>(functorParams);
    assert(params);
...
{
    FindExtremeByComparisonParams *params = static_cast<FindExtremeByComparisonParams *>(functorParams);
    assert(params);
...
{
    FindAllByComparisonParams *params = static_cast<FindAllByComparisonParams *>(functorParams);
    assert(params);
...
{
    FindAllBetweenParams *params = static_cast<FindAllBetweenParams *>(functorParams);
    assert(params);
...
{
    FindAllReferencedObjectsParams *params = static_cast<FindAllReferencedObjectsParams *>(functorParams);
    assert(params);
...
{
    PrepareFacsimileParams *params = static_cast<PrepareFacsimileParams *>(functorParams);
    assert(params);
...
{
    PrepareLinkingParams *params = static_cast<PrepareLinkingParams *>(functorParams);
    assert(params);
...
{
    PreparePlistParams *params = static_cast<PreparePlistParams *>(functorParams);
    assert(params);
...
{
    SetCautionaryScoreDefParams *params = static_cast<SetCautionaryScoreDefParams *>(functorParams);
    assert(params);
    ...
    if (this->Is(STAFF)) {
        Staff *staff = static_cast<Staff *>(this);
        assert(staff);
    ...
    if (this->Is(LAYER)) {
        Layer *layer = static_cast<Layer *>(this);
        assert(layer);
...
{
    SetCurrentScoreDefParams *params = static_cast<SetCurrentScoreDefParams *>(functorParams);
    assert(params);
    ...
    if (this->Is(SYSTEM)) {
        System *system = static_cast<System *>(this);
        assert(system);
    ...
    if (this->Is(MEASURE)) {
        Measure *measure = static_cast<Measure *>(this);
        assert(measure);
    ...
    if (this->Is(SCOREDEF)) {
        ScoreDef *scoreDef = static_cast<ScoreDef *>(this);
        assert(scoreDef);
    ...
    if (this->Is(STAFFDEF)) {
        StaffDef *staffDef = static_cast<StaffDef *>(this);
        assert(staffDef);
    ...
    // starting a new clef
    if (this->Is(CLEF)) {
        LayerElement *element = static_cast<LayerElement *>(this);
        assert(element);
        Clef *clef = static_cast<Clef *>(element->ThisOrSameasAsLink());
        assert(clef);
    ...
    if (this->Is(KEYSIG)) {
        KeySig *keySig = static_cast<KeySig *>(this);
        assert(keySig);
...
{
    GetAlignmentLeftRightParams *params = static_cast<GetAlignmentLeftRightParams *>(functorParams);
    assert(params);
...
{
    SetOverflowBBoxesParams *params = static_cast<SetOverflowBBoxesParams *>(functorParams);
    assert(params);

    // starting a new staff
    if (this->Is(STAFF)) {
        Staff *currentStaff = static_cast<Staff *>(this);
        assert(currentStaff);
    ...
    // starting new layer
    if (this->Is(LAYER)) {
        Layer *currentLayer = static_cast<Layer *>(this);
        assert(currentLayer);
        // set scoreDef attr
    ...
    LayerElement *current = static_cast<LayerElement *>(this);
    assert(current);
...
{
    SaveParams *params = static_cast<SaveParams *>(functorParams);
    assert(params);
