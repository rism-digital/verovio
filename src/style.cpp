...
Style::Style()
{
    ...
    m_leftMarginBarLineAttr = DEFAULT_LEFT_MARGIN_BARLINE_ATTR * DEFINITION_FACTOR;
    ...
    m_rightMarginBarLineAttr = DEFAULT_RIGHT_MARGIN_BARLINE_ATTR * DEFINITION_FACTOR;
