...
int System::JustifyX(FunctorParams *functorParams)
{
    ...
    if (params->m_justifiableRatio < 0.8) {
        ...
        LogWarning("\tSystem full width: %lf", params->m_systemFullWidth);
        LogWarning("\tNon-justifiable width: %lf", nonJustifiableWidth);
        LogWarning("\tDrawing Justifiable width: %lf", m_drawingJustifiableWidth);
    }
