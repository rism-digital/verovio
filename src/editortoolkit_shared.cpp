...
bool EditorToolkitShared::Insert(std::string &elementType, std::string const &startid, std::string const &endid)
{
...
bool EditorToolkitShared::Insert(std::string &elementType, std::string const &startid)
{
    if (!m_doc->GetDrawingPage()) return false;
...
bool EditorToolkitShared::InsertNote(Object *object)
{
    assert(object);
...
bool EditorToolkitShared::DeleteNote(Note *note)
{
    assert(note);
