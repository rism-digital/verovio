...
class toolkit:
    ...
    def registerTextFont(self, data: bytes, alias: str = "") -> str: ...
    def registerMusicFont(self, data: bytes, smuflMetadataJson: str, alias: str = "") -> str: ...
    def registerTextFontBase64(self, data: str, alias: str = "") -> str: ...
    def registerMusicFontBase64(self, data: str, smuflMetadataJson: str, alias: str = "") -> str: ...
    def registerTextFontFile(self, filename: str, alias: str = "") -> str: ...
    def registerMusicFontFile(self, filename: str, smuflMetadataFilename: str, alias: str = "") -> str: ...
