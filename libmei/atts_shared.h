...
public:
     ...
     * Getter for reference (for alternate type only)
     **/
    const data_STAFFITEM *GetAboveorderAlternate() const { return &m_aboveorder; }
    //
     ...
     * Getter for reference (for alternate type only)
     **/
    const data_STAFFITEM *GetBeloworderAlternate() const { return &m_beloworder; }
    //
     ...
     * Getter for reference (for alternate type only)
     **/
    const data_STAFFITEM *GetBetweenorderAlternate() const { return &m_betweenorder; }
    ///@}
