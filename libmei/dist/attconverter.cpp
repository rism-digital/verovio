...
std::string AttConverterBase::AccidentalGesturalToStr(data_ACCIDENTAL_GESTURAL data) const
{
    ...
    switch (data) {
        ...
        case ACCIDENTAL_GESTURAL_x: value = "x"; break;
        case ACCIDENTAL_GESTURAL_ff: value = "ff"; break;
        case ACCIDENTAL_GESTURAL_xs: value = "xs"; break;
        case ACCIDENTAL_GESTURAL_sx: value = "sx"; break;
        ...
        case ACCIDENTAL_GESTURAL_nf: value = "nf"; break;
        case ACCIDENTAL_GESTURAL_ns: value = "ns"; break;
        ...
        case ACCIDENTAL_GESTURAL_nu: value = "nu"; break;
        case ACCIDENTAL_GESTURAL_nd: value = "nd"; break;
        case ACCIDENTAL_GESTURAL_xu: value = "xu"; break;
        case ACCIDENTAL_GESTURAL_xd: value = "xd"; break;
        case ACCIDENTAL_GESTURAL_ffu: value = "ffu"; break;
        case ACCIDENTAL_GESTURAL_ffd: value = "ffd"; break;
        case ACCIDENTAL_GESTURAL_1qf: value = "1qf"; break;
        case ACCIDENTAL_GESTURAL_3qf: value = "3qf"; break;
        case ACCIDENTAL_GESTURAL_1qs: value = "1qs"; break;
        case ACCIDENTAL_GESTURAL_3qs: value = "3qs"; break;
...
data_ACCIDENTAL_GESTURAL AttConverterBase::StrToAccidentalGestural(const std::string &value, bool logWarning) const
{
    ...
    if (value == "x") return ACCIDENTAL_GESTURAL_x;
    if (value == "ff") return ACCIDENTAL_GESTURAL_ff;
    if (value == "xs") return ACCIDENTAL_GESTURAL_xs;
    if (value == "sx") return ACCIDENTAL_GESTURAL_sx;
    ...
    if (value == "nf") return ACCIDENTAL_GESTURAL_nf;
    if (value == "ns") return ACCIDENTAL_GESTURAL_ns;
    ...
    if (value == "nu") return ACCIDENTAL_GESTURAL_nu;
    if (value == "nd") return ACCIDENTAL_GESTURAL_nd;
    if (value == "xu") return ACCIDENTAL_GESTURAL_xu;
    if (value == "xd") return ACCIDENTAL_GESTURAL_xd;
    if (value == "ffu") return ACCIDENTAL_GESTURAL_ffu;
    if (value == "ffd") return ACCIDENTAL_GESTURAL_ffd;
    if (value == "1qf") return ACCIDENTAL_GESTURAL_1qf;
    if (value == "3qf") return ACCIDENTAL_GESTURAL_3qf;
    if (value == "1qs") return ACCIDENTAL_GESTURAL_1qs;
    if (value == "3qs") return ACCIDENTAL_GESTURAL_3qs;
