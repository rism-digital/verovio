...
enum data_ACCIDENTAL_GESTURAL : int8_t {
    ...
    ACCIDENTAL_GESTURAL_x,
    ACCIDENTAL_GESTURAL_ff,
    ACCIDENTAL_GESTURAL_xs,
    ACCIDENTAL_GESTURAL_sx,
    ACCIDENTAL_GESTURAL_ts,
    ACCIDENTAL_GESTURAL_tf,
    ACCIDENTAL_GESTURAL_n,
    ACCIDENTAL_GESTURAL_nf,
    ACCIDENTAL_GESTURAL_ns,
    ACCIDENTAL_GESTURAL_su,
    ACCIDENTAL_GESTURAL_sd,
    ACCIDENTAL_GESTURAL_fu,
    ACCIDENTAL_GESTURAL_fd,
    ACCIDENTAL_GESTURAL_nu,
    ACCIDENTAL_GESTURAL_nd,
    ACCIDENTAL_GESTURAL_xu,
    ACCIDENTAL_GESTURAL_xd,
    ACCIDENTAL_GESTURAL_ffu,
    ACCIDENTAL_GESTURAL_ffd,
    ACCIDENTAL_GESTURAL_1qf,
    ACCIDENTAL_GESTURAL_3qf,
    ACCIDENTAL_GESTURAL_1qs,
    ACCIDENTAL_GESTURAL_3qs,
