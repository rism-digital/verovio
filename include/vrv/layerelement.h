...
protected:
     ...
     */
    virtual MapOfNoteLocs CalcNoteLocations([[maybe_unused]] NotePredicate predicate = NULL) const { return {}; }
     ...
     * secondary
     */
    virtual MapOfDotLocs CalcDotLocations([[maybe_unused]] int layerCount, [[maybe_unused]] bool primary) const
    {
        return {};
    }
