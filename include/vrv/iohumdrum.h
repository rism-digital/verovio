...
class HumdrumInput : public FileInputStream {
	...
	private:
		...
		/**
	 	* @name Top level methods for reading Humdrum part and measure elements.
	 	*/
		///@{
		...
		/**
	 	* @name Methods for reading the content of a Humdrum measure.
	 	*/
		///@{
		...
		/**
	 	* @name Methods for converting Humdrum string values to MEI attributes.
	 	*/
		///@{
